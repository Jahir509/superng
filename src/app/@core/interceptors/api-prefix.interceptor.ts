...
export class ApiPrefixInterceptor implements HttpInterceptor {
  ...
  intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
    ...
    /***
     * In below piece of code If there is an ongoing request with the same
     * method and URL than return the ongoing request instead of creating a
     * new one
     * This is useful when the user clicks multiple times on a button that
     * triggers a request
     ***/
